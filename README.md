...
3. **Deploy to Liferay**: Use `scottish-power-collection-20250709_123524.zip` for production deployment
...
├── scottish-power-collection-20250709_123524.zip # Liferay deployment package
