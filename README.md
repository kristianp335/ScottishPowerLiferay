...
3. **Deploy to Liferay**: Use `scottish-power-collection-20250709_123524-fixed.zip` for production deployment (includes FreeMarker template fixes)
...
├── scottish-power-collection-20250709_123524-fixed.zip # Liferay deployment package (FreeMarker fixes)
